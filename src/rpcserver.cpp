...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WINO features */
        {"wino", "masternode", &masternode, true, true, false},
        {"wino", "masternodelist", &masternodelist, true, true, false},
        {"wino", "mnbudget", &mnbudget, true, true, false},
        {"wino", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"wino", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wino", "mnsync", &mnsync, true, true, false},
        {"wino", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"wino", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use winod, or the -server option to wino-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wino-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27782/\n";
}
