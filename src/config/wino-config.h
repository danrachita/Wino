/* src/config/wino-config.h.  Generated from wino-config.h.in by configure.  */
/* src/config/wino-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WINO_CONFIG_H

#define WINO_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://wino.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Wino Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Wino Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "wino"
