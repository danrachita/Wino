...
#if defined(NDEBUG)
#error "Wino cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Wino Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 4000 ) {
	        ...
	        nSubsidy = 7 * COIN;
	} else if( nHeight > 8000 && nHeight <= 16000 ) {
	        nSubsidy = 14 * COIN;
	} else if( nHeight > 16000 && nHeight <= 24000 ) {
	        nSubsidy = 22 * COIN;
	} else if( nHeight > 24000 && nHeight <= 28000 ) {
	        nSubsidy = 100 * COIN;
	} else if( nHeight > 28000 && nHeight <= 32000 ) {
	        nSubsidy = 140 * COIN;
	} else if( nHeight > 32000 && nHeight <= 64000 ) {
	        nSubsidy = 202 * COIN;
	} else if( nHeight > 64000 && nHeight <= 350000 ) {
	        nSubsidy = 121 * COIN;
