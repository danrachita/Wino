...
RESOURCES += src/qt/wino.qrc src/qt/wino_locale.qrc

TRANSLATIONS += src/qt/locale/wino_bg.ts \
                src/qt/locale/wino_de.ts \
                src/qt/locale/wino_en.ts \
                src/qt/locale/wino_es.ts \
                src/qt/locale/wino_fi.ts \
                src/qt/locale/wino_fr.ts \
                src/qt/locale/wino_it.ts \
                src/qt/locale/wino_ja.ts \
                src/qt/locale/wino_pl.ts \
                src/qt/locale/wino_pt.ts \
                src/qt/locale/wino_ru.ts \
                src/qt/locale/wino_sk.ts \
                src/qt/locale/wino_sv.ts \
                src/qt/locale/wino_vi.ts \
                src/qt/locale/wino_zh_CN.ts \
                src/qt/locale/wino_zh_TW.ts
